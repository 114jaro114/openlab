...
export default {
  ...
  data() {
    return {
      ...
      lastUpdate: localStorage.getItem('lastUpdateSound'),
      seriesCircle: [],
      chartOptionsCircle: {
        chart: {
  ...
  methods: {
    ...
    getHistoricalData2() {
      axios.get('https://openlabbe2021.azurewebsites.net/api/getHistoricalData2Sound')
        .then(res => {
    ...
    getHistoricalData3() {
      axios.get('https://openlabbe2021.azurewebsites.net/api/getHistoricalData3Sound')
        .then(res => {
    ...
    getDataRealtime() {
      axios.get('https://openlabbe2021.azurewebsites.net/api/getDataRealtimeSound')
        .then(res => {
          this.lastUpdate = moment(new Date)
            .format('YYYY-MM-DD HH:mm:ss');
          localStorage.setItem("lastUpdateSound", moment(new Date)
            .format('YYYY-MM-DD HH:mm:ss'));
          ...
          this.seriesCircle.push(parseFloat(res.data[res.data.length - 1].vol));
    ...
    getHistoricalData() {
      axios.get('https://openlabbe2021.azurewebsites.net/api/getHistoricalDataSound')
        .then(res => {
    ...
    window.Echo.channel('dataAllSensors')
      .listen('AllSensorsEvent', (e) => {
        ...
        this.series[0].data.push([
          ...
          .valueOf(),
          parseFloat(`${e.dataAllSensors.vol}`)
        ]);
        this.series = [{
          data: this.series[0].data
        }];
