...
export default {
  ...
  methods: {
    ...
    getHistoricalData2() {
      axios.get('http://127.0.0.1:8000/api/getHistoricalData2Sound')
        .then(res => {
    ...
    getHistoricalData3() {
      axios.get('http://127.0.0.1:8000/api/getHistoricalData3Sound')
        .then(res => {
    ...
    getHistoricalData() {
      axios.get('http://127.0.0.1:8000/api/getHistoricalDataSound')
        .then(res => {
