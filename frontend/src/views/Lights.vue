...
export default {
  ...
  methods: {
    ...
    getHistoricalData2() {
      axios.get('http://127.0.0.1:8000/api/getHistoricalData2Light')
        .then(res => {
    ...
    getHistoricalData3() {
      axios.get('http://127.0.0.1:8000/api/getHistoricalData3Light')
        .then(res => {
    ...
    getDataRealtime() {
      axios.get('http://127.0.0.1:8000/api/getDataRealtimeLight')
        .then(res => {
    ...
    getHistoricalData() {
      axios.get('http://127.0.0.1:8000/api/getHistoricalDataLight')
        .then(res => {
  ...
  created() {
    ...
    window.Echo.channel('dataAllSensors')
      .listen('AllSensorsEvent', (e) => {
        ...
        //
        this.seriesCircle.splice(0, 1);
        this.seriesCircle.push(parseFloat(e.dataAllSensors.light));
        this.getDataRealtime();
        this.getHistoricalData2();
        this.getHistoricalData3();
      })
