...
export default {
  ...
  methods: {
    ...
    getHistoricalData2() {
      axios.get('https://openlabbe2021.azurewebsites.net/api/getHistoricalData2Light')
        .then(res => {
    ...
    getHistoricalData3() {
      axios.get('https://openlabbe2021.azurewebsites.net/api/getHistoricalData3Light')
        .then(res => {
    ...
    getDataRealtime() {
      axios.get('https://openlabbe2021.azurewebsites.net/api/getDataRealtimeLight')
        .then(res => {
    ...
    getHistoricalData() {
      axios.get('https://openlabbe2021.azurewebsites.net/api/getHistoricalDataLight')
        .then(res => {
