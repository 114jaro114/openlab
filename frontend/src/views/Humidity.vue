...
export default {
  ...
  methods: {
    ...
    getHistoricalData2() {
      axios.get(`${process.env.VUE_APP_API_URL}/api/getHistoricalData2Humidity`)
        .then(res => {
    ...
    getHistoricalData3() {
      axios.get(`${process.env.VUE_APP_API_URL}/api/getHistoricalData3Humidity`)
        .then(res => {
    ...
    getDataRealtime() {
      axios.get(`${process.env.VUE_APP_API_URL}/api/getDataRealtimeHumidity`)
        .then(res => {
          this.lastUpdate = moment(new Date)
            .format('YYYY-MM-DD HH:mm:ss');
          localStorage.setItem("lastUpdateHumidity", moment(new Date)
            .format('YYYY-MM-DD HH:mm:ss'));
    ...
    getHistoricalData() {
      axios.get(`${process.env.VUE_APP_API_URL}/api/getHistoricalDataHumidity`)
        .then(res => {
