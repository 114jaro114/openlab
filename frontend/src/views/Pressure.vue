...
export default {
  ...
  methods: {
    ...
    getHistoricalData2() {
      axios.get(`${process.env.VUE_APP_API_URL}/api/getHistoricalData2Pressure`)
        .then(res => {
    ...
    getHistoricalData3() {
      axios.get(`${process.env.VUE_APP_API_URL}/api/getHistoricalData3Pressure`)
        .then(res => {
    ...
    getDataRealtime() {
      axios.get(`${process.env.VUE_APP_API_URL}/api/getDataRealtimePressure`)
        .then(res => {
    ...
    getHistoricalData() {
      axios.get(`${process.env.VUE_APP_API_URL}/api/getHistoricalDataPressure`)
        .then(res => {
