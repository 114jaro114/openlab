...
export default {
  ...
  methods: {
    getDataAreasGroup() {
      axios.get('https://openlabbe2021.azurewebsites.net/api/getDataAreasGroup')
        .then(res => {
    ...
    getDataDashed() {
      axios.get('https://openlabbe2021.azurewebsites.net/api/getDataHome')
        .then(res => {
    ...
    getDataLine() {
      axios.get('https://openlabbe2021.azurewebsites.net/api/getDataLine')
        .then(res => {
    ...
    getDataCircleMultiple() {
      axios.get('https://openlabbe2021.azurewebsites.net/api/getDataCircleMultiple')
        .then(res => {
