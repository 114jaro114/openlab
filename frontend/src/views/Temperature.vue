...
export default {
  ...
  methods: {
    ...
    getHistoricalDataGtmp() {
      axios.get(`${process.env.VUE_APP_API_URL}/api/getHistoricalDataTemperatureGtmp`)
        .then(res => {
    ...
    getHistoricalData2Gtmp() {
      axios.get(`${process.env.VUE_APP_API_URL}/api/getHistoricalData2TemperatureGtmp`)
        .then(res => {
    ...
    getHistoricalData3Gtmp() {
      axios.get(`${process.env.VUE_APP_API_URL}/api/getHistoricalData3TemperatureGtmp`)
        .then(res => {
    ...
    getDataRealtimeGtmp() {
      axios.get(`${process.env.VUE_APP_API_URL}/api/getDataRealtimeTemperatureGtmp`)
        .then(res => {
    ...
    getHistoricalDataAtmp() {
      axios.get(`${process.env.VUE_APP_API_URL}/api/getHistoricalDataTemperatureAtmp`)
        .then(res => {
    ...
    getHistoricalData2Atmp() {
      axios.get(`${process.env.VUE_APP_API_URL}/api/getHistoricalData2TemperatureAtmp`)
        .then(res => {
    ...
    getHistoricalData3Atmp() {
      axios.get(`${process.env.VUE_APP_API_URL}/api/getHistoricalData3TemperatureAtmp`)
        .then(res => {
          // this.seriesColumn[0].data = [];
    ...
    getDataRealtimeAtmp() {
      axios.get(`${process.env.VUE_APP_API_URL}/api/getDataRealtimeTemperatureAtmp`)
        .then(res => {
          this.lastUpdate = moment(new Date)
            .format('YYYY-MM-DD HH:mm:ss');
          localStorage.setItem("lastUpdateTemperatures", moment(new Date)
